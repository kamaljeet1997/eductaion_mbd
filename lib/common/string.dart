class Strings {
  ...
  static const unknownError = 'Server connection error.';
  static const connectionTimeout = 'Oops, it looks like your connection is weak. Please try again later';
  static const noConnection = 'Oops, it looks like your connection is weak. Please try again later';
  static const unauthorize = 'Unauthorized. Please login again!';
  static const html_error = 'Our system is temporarily undergoing maintenance. Please try after sometime.';
  static const show_error = "type 'String' is not a subtype of type 'Map<String, dynamic>'";

  static const String appName = 'Getx Start Project';
  static const String ok = 'Ok';
  static const String error = 'Error';
  static const String message = 'Alert';
  ...
  static const getStartWithLearning = "Let's Get Started With Learning";
