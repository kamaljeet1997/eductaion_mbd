  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Padding(
          padding:  EdgeInsets.only(top: Get.height/9,left: 20,right: 20),
                                      ...
                                      child: Column(
                                        children: [
                                          InkWell(
                                            onTap: (){
                                              Map map={
                                                "subjectName":controller.getSubjects[i]['name'],
                                                "Ebook_link":controller.getSubjects[i]['Ebook_link'] == ""?"":controller.getSubjects[i]['Ebook_link']!.replaceAll(" ", "%20"),
                                                "Animation_link":controller.getSubjects[i]['Animation_link'] == ""?"":controller.getSubjects[i]['Animation_link']!.replaceAll(" ", "%20"),
                                                "Interactivity_link":controller.getSubjects[i]['Interactivity_link'] == ""?"":controller.getSubjects[i]['Interactivity_link']!.replaceAll(" ", "%20"),
                                                "TG_link":controller.getSubjects[i]['TG_link'] == ""?"":controller.getSubjects[i]['TG_link']!.replaceAll(" ", "%20"),
                                              "Assessment_link":""
                                              };
