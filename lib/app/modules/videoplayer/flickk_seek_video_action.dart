...
class FlickSeekVideoActions extends StatelessWidget {
  const FlickSeekVideoActions({
    Key? key,
    this.child,
    this.forwardSeekIcon = const Icon(Icons.forward_10_rounded, color: AppColors.header_color,size: 40,),
    this.backwardSeekIcon = const Icon(Icons.replay_10_outlined,color: AppColors.header_color,size: 40,),
            ...
            GestureDetector(
              ...
              child: Align(
                ...
                child: AnimatedCrossFade(
                  ...
                  firstChild: IconTheme(data: IconThemeData(color: Colors.transparent),
                    child: backwardSeekIcon,),
                  crossFadeState: showBackwardSeek? CrossFadeState.showSecond: CrossFadeState.showFirst,
            ...
            GestureDetector(
              ...
              child: Align(
                ...
                child: AnimatedCrossFade(
                  ...
                  crossFadeState: showForwardSeek? CrossFadeState.showSecond: CrossFadeState.showFirst,
                  secondChild: IconTheme(data: IconThemeData(color: Colors.white),
                    child: forwardSeekIcon,
                  ),
                ),
              ),
